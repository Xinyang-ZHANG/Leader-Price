...
QT_MOC_LITERAL(4, 26, 4), // "text"
QT_MOC_LITERAL(5, 31, 14) // "selectFunction"

    },
    "MyButton\0sendtext\0\0string\0text\0"
    "selectFunction"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->selectFunction(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyButton::*)(string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::sendtext)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyButton::sendtext(string _t1)
{
